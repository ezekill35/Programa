  ...
  snapshot.forEach(docu => {
    ...
    tr.innerHTML = `
      ...
      <td>
        ...
        <button class="btn btn-sm eliminar" data-id="${docu.id}" data-tipo="proveedor">🗑️ Eliminar</button>
  ...
  snapshot.forEach(docu => {
    ...
    tr.innerHTML = `
      ...
      <td>
        ...
        <button class="btn btn-sm eliminar" data-id="${docu.id}" data-tipo="producto">🗑️ Eliminar</button>
...
document.addEventListener("click", async e => {
  ...
  if (e.target.classList.contains("editar")) {
    ...
    const docRef = tipo === "proveedor" ? doc(db, "proveedores", id) : doc(db, "productos", id);
    const snap = await getDocs(tipo === "proveedor" ? query(colProveedores) : query(colProductos));
  ...
  if (e.target.classList.contains("eliminar")) {
    ...
    const tipo = e.target.dataset.tipo;
    const id = e.target.dataset.id;
    const docRef = tipo === "proveedor" ? doc(db, "proveedores", id)
                     : tipo === "producto" ? doc(db, "productos", id)
                     : doc(db, "facturas", id);
