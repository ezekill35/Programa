  ...
  proveedores.forEach(p => {
    listaProveedores.innerHTML += `
      <tr>
        ...
        <td>${p.producto}</td>
        <td>
          <button class="btn btn-warning btn-sm" onclick="editarProveedor('${p.id}')">✏️</button>
          <button class="btn btn-danger btn-sm" onclick="eliminarProveedorFirebase('${p.id}')">❌</button>
        </td>
      </tr>
    `;
  });
  ...
  facturas.forEach(f => {
    listaFacturas.innerHTML += `
      <tr>
        ...
        <td>
          <button class="btn btn-warning btn-sm" onclick="editarFactura('${f.id}')">✏️</button>
          <button class="btn btn-danger btn-sm" onclick="eliminarFacturaFirebase('${f.id}')">❌</button>
        </td>
      </tr>
    `;
  });
  ...
  gastos.forEach(g => {
    listaGastos.innerHTML+=`
      <tr>
        ...
        <td>${g.fecha}</td>
        <td>
          <button class="btn btn-warning btn-sm" onclick="editarGasto('${g.id}')">✏️</button>
          <button class="btn btn-danger btn-sm" onclick="eliminarGastoFirebase('${g.id}')">❌</button>
        </td>
      </tr>
    `;
  });
